...
function load(scriptPath) {
    ...
    const sandbox = vm_1.default.createContext(Object.assign(Object.assign({}, global), { exports: userModule.exports, module: userModule, require: name => {
    ...
    vm_1.default.runInContext(moduleCode, sandbox, { filename: userModule.filename });
